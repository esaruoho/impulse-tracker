...
| loader-sample-view-follows-cursor | 3 | ✓ | ✗ | ✗ | @build-verified @hw-untested @runtime-untested @shipped |
...
| pattern-rows-guard | 5 | ✓ | ✗ | ✗ | @build-verified @hw-untested @runtime-untested @shipped |
...
- **Hardware-verified: 16**  ·  hardware-untested: 21
