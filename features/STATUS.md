...
|------|----:|:-----:|:----------------:|:--------:|----------------|
| alt-r-replicate | 5 | ✓ | ✗ | ✗ | @build-verified @hw-untested @runtime-untested @shipped |
...
- Cards: 20
- Build-verified: 20
- Runtime-verified in DOSBox-X: 3 full + 2 partial
- **Hardware-verified: 0**  ·  hardware-untested: 19
