# Convey — Sessions Ledger (curated overlay)

> **The live, auto-discovered list is `features/CONVEY-SESSIONS.generated.md`** —
> generated by `features/gen-sessions.py` from this machine's Claude transcripts
> (resume command + cards/tools each conversation touched). Don't hand-maintain the
> session list; this file is only the CURATED overlay: human roles + distillation
> status on top of the generated registry. The single distilled situation is
> `features/CONVEY-SITUATION.md`.
>
