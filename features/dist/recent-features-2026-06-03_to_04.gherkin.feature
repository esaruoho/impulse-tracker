# Pure Gherkin test extracted from features/recent-features-2026-06-03_to_04.feature
# (report-card banner stripped; inline # cite: traceability kept)
# Regenerate: python3 features/print-card.py features/recent-features-2026-06-03_to_04.feature
