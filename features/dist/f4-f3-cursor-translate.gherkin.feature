# Pure Gherkin test extracted from features/f4-f3-cursor-translate.feature
# (report-card banner stripped; inline # cite: traceability kept)
# Regenerate: python3 features/print-card.py features/f4-f3-cursor-translate.feature
