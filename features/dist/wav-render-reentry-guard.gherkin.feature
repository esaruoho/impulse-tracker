# Pure Gherkin test extracted from features/wav-render-reentry-guard.feature
# (report-card banner stripped; inline # cite: traceability kept)
# Regenerate: python3 features/print-card.py features/wav-render-reentry-guard.feature
