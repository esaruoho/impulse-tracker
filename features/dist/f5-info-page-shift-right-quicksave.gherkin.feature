# Pure Gherkin test extracted from features/f5-info-page-shift-right-quicksave.feature
# (report-card banner stripped; inline # cite: traceability kept)
# Regenerate: python3 features/print-card.py features/f5-info-page-shift-right-quicksave.feature
