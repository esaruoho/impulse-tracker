# Pure Gherkin test extracted from features/schismtracker-port-backlog.feature
# (report-card banner stripped; inline # cite: traceability kept)
# Regenerate: python3 features/print-card.py features/schismtracker-port-backlog.feature
