# Pure Gherkin test extracted from features/session-changes-codespace.feature
# (report-card banner stripped; inline # cite: traceability kept)
# Regenerate: python3 features/print-card.py features/session-changes-codespace.feature
