# Pure Gherkin test extracted from features/convey-session-distiller.feature
# (report-card banner stripped; inline # cite: traceability kept)
# Regenerate: python3 features/print-card.py features/convey-session-distiller.feature
