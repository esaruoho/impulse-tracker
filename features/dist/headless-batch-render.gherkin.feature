# Pure Gherkin test extracted from features/headless-batch-render.feature
# (report-card banner stripped; inline # cite: traceability kept)
# Regenerate: python3 features/print-card.py features/headless-batch-render.feature
