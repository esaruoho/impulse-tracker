# Pure Gherkin test extracted from features/debug-logging-channels.feature
# (report-card banner stripped; inline # cite: traceability kept)
# Regenerate: python3 features/print-card.py features/debug-logging-channels.feature
