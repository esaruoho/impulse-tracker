...
#   IT_DISK.ASM - LSVSL_BackfillInstruments (Samples Mode -> Instrument Mode backfill)
#   IT_DISK.ASM - LSViewWindowKeys (146h/13Ah entries)
#   IT_OBJ1.ASM - GlobalKeyList (Shift-F3 and Caps Lock -> Sample Load)
#   IT_PE.ASM   - PE_ScrollLockDispatch / PE_ScrollLockLoadSample
#                 (Shift-Scroll Lock and fallback keys -> Sample Load)
#   IT_PE.ASM   - PE_CapsLoadSample (global Caps Lock -> Sample Load round-trip)
#   IT_PE.ASM   - PE_ScrollLockFollow (editor Scroll Lock: normal Follow toggle)
# Commit log:   <stamped by hook>
# SESSION:      features/loader-scrolllock-load-and-jam.session.md
# RESULT:       <stamped by hook>
# WATCH: GlobalKeyList LSViewWindow_ScrollLock LSVSL_BackfillInstruments PE_ScrollLockDispatch PE_ScrollLockLoadSample PE_CapsLoadSample PE_ScrollLockFollow
# =============================================================================
