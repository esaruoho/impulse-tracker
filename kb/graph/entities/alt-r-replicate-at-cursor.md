...
## Claims
- Scenario (L54): Alt-R and Shift-Alt-R are disambiguated by live shift state
- Scenario (L66): Cursor above row 0 tiles the rows-above-cursor chunk downward
- Scenario (L75): Cursor on row 0 tiles row 0 down the whole channel
- Scenario (L82): No-op at the pattern edges
- Scenario (L90): Shift-Alt-R replicates the whole PATTERN at cursor
- Scenario (L109): Both replicate ops are undoable and show a correct label in the undo list
